...
<section class="banner inner-banner inner-banner5">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-7" data-aos="fade-left" data-aos-duration="1200">
            <h5 class="text-white pb-3">Publishing Your Stories To A Global Audience</h5>
            <h1 class="text-white">Tell Your Story To The World Through <span
               class="d-content primary-color">amazon kdp expert</span></h1>
            <p class="text-white py-3">
               Have your masterpiece ready for the world but don’t know how to publish it? Amazon Publishing
               Pros have got you covered! Our professional publishing team ensures your masterpiece will reach
               its target audience. With our support, becoming a published author has never been easier.
               AmazonPublishigPros
            </p>
            <div class="trust">
               <div class="new_frm">
...
<!--    <div class="social-medias">
      <ul class="menu">
         <li><a href="https://www.facebook.com/amzpublishingpros" target="_blank"><i
            class="fab fa-facebook-f"></i></a></li>
         <li><a href="https://twitter.com/Amzpubpro" target="_blank"><i class="fab fa-twitter"></i></a></li>
         <li><a href="https://www.linkedin.com/company/amazon-publishing-pros" target="_blank"><i
            class="fab fa-linkedin-in"></i></a></li>
         <li><a href="https://www.instagram.com/amzpublishingpros/" target="_blank"><i
...
<section class="book-stone">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-6">
            <h2>The Most Efficient Publishing Process</h2>
            <p class="py-3"> At amazon kdp expert, we have a team of experienced writers and publishers who
               have made their mark in the industry. Our process is simple, systematic, and fast. With the
               publishing team’s excellence and expertise, amazon kdp expert have successfully assisted
               hundreds of aspiring writers worldwide to achieve their dream of becoming published authors with
         ...
         <div class="col-md-6">
            <img src="assets/images/book-pub.png" alt="" style="width:500px;">
         </div>
      </div>
   </div>
</section>
