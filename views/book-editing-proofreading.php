   ...
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-7" data-aos="fade-left" data-aos-duration="1200">
            <h5 class="text-white pb-3">Your Final Draft Should Be Error-free</h5>
            <h1 class="text-white">Let Our <span class="d-content primary-color"> Editors And Proofreaders
               </span> Perform A Deep Scrutiny On Your Written Pieces.
            </h1>
            <p class="text-white py-3">
               Our team of linguistic professionals will edit and proofread your book to ensure there are no
               grammatical errors, structural mistakes, or issues of verbiage, so your masterpiece is flawless.
            </p>
            <div class="trust">
               <div class="new_frm">
...
<section class="book-stone">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-6">
            <h2>Unparalleled Editing And Proofreading Services, Only At amazon kdp expert</h2>
            <p class="py-3"> Whether you are an internationally acclaimed author or just starting, sometimes you
               need an expert to go through your best work. At amazon kdp expert, our team of expert
               editors ensures that your work is error-free and matches the standards of publishing. Let the
               most versatile experts at amazon kdp expert analyze your masterpiece and make it flawless.
            </p>
            <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
         ...
         <div class="col-md-6">
            <img src="assets/images/proof-read.png" alt="" style="width:650px;">
         </div>
      </div>
   </div>
</section>
