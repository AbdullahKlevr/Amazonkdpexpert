...
<section class="banner inner-banner inner-banner4">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-7" data-aos="fade-left" data-aos-duration="1200">
            <h5 class="text-white pb-3">Design That Leaves An Instant Impact</h5>
            <h1 class="text-white"><span class="d-content primary-color">Book Illustration </span> Services at
               amazon kdp expert 
            </h1>
            <p class="text-white py-3">
               amazon kdp expert are well-known at providing cost-effective book illustration services.
               Our expert illustrators provide high-quality book illustrations at minimal costs.
            </p>
            <div class="trust">
               <div class="new_frm">
...
<section class="book-stone">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-6">
            <h2>Book Illustration Services</h2>
            <p class="pt-3"> amazon kdp expert’ expert illustrations team understands the importance of
               cover art and illustrations – whether it’s children’s books, comic books, graphic novels,
               textbooks, or e-books, we’ve got you covered! The right images and illustrations will translate
               the author’s information, sentiment, or emotional tones; that’s why amazon kdp expert’
               accomplished illustrators work closely with authors to ensure their theme, characters, message,
               and style shines through. Whether it’s illustrating books from scratch or conceptualized artwork
               to match previous works, we’ve done it all.
            </p>
            <p class="pb-3">
               Whether you're looking for illustrations for your book cover or the entire book, Amazon’s
               professional team of book illustrators will create engaging illustrations that will attract your
               audiences at first glance.
            </p>
            <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
         ...
         <div class="col-md-6">
            <img src="assets/images/book-illus.png" alt="">
         </div>
      </div>
   </div>
</section>
