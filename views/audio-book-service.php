...
<section class="banner inner-banner inner-banner2">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-7" data-aos="fade-left" data-aos-duration="1200">
            <h5 class="text-white pb-3">Audiobook Production Services Online</h5>
            <h1 class="text-white">amazon kdp expert can help you reach <span
               class="d-content primary-color">new audiobook</span>
               readers
            </h1>
            <p class="text-white py-3">
               With over 100 million titles available, amazon kdp expert can help you reach new audiobook
               readers by publishing your book with our audio book service. With our fast turnaround time and
               affordable rates, we are the best choice for publishers looking for a professional audio book
               option.
            </p>
            <div class="trust">
               <div class="new_frm">
...
<input type="hidden" name="news" value="1">
           <input type="hidden" name="subject" value="Banner Form (amazonkdpexpert.com)"></form>
               ...
               <img class="pb-4" src="https://amazonkdpexpert.com/assets/images/trust.png"
...
<section class="book-stone">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-6">
            <h2>AudioBook Publishing at its Best!</h2>
            <p class="py-3"> We offer over 100 million titles to choose from to publish your next audiobook.
               With our quick turn-around time and affordable rates, we are the best choice for publishers
               looking for a professional audio book option. We can get a full production team to produce your
               audiobook, including narration, production, publishing, distribution, and marketing. We also
               have an in-house editorial team that can edit your content as well as provide guidance on what
               makes a great audiobook.
            </p>
            <div class="audio-samples d-flex mb-3">
               <audio controls>
                  <source src="assets/videos/audio1.mp3" type="audio/mpeg">
                  Your browser does not support the audio element.
               </audio>
               <audio controls class="pl-2">
                  <source src="assets/videos/audio2.mp3" type="audio/mpeg">
                  Your browser does not support the audio element.
               </audio>
            </div>
            <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
         ...
         <div class="col-md-6">
            <img src="https://amazonkdpexpert.com/assets/images/audio-book.png" alt="" style="width:650px;">
         </div>
      </div>
   </div>
</section>
