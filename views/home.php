...
<section class="banner main-banner banner_news">
	...
	<div class="container" data-aos="fade-up" data-aos-duration="1000">
		<div class="row align-items-center center-sect">
			<div class="col-md-8" data-aos="fade-left" data-aos-duration="1200">
				<h5 class="text-white pb-3">Ready to tell the world your story?</h5>
				<h1 class="text-white">
					Let us help you become a <span class="d-content primary-color">best-selling</span> author!
				</h1> 
				<p class="text-white py-3"> Get back on track with amazon kdp expert! We offer a range of writing, editing, publishing and marketing solutions: </p>
				<div class="trust">
					<ul class="menu menu-dot text-white pb-3">
						<li>Ghostwriting</li>
...
<input type="hidden" name="news" value="1">
           <input type="hidden" name="subject" value="Banner Form (amazonkdpexpert.com)"></form>
					...
					<!--	<img class="pb-4 lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/trust.webp" alt="amazon kdp expert"> -->
					<!--</a> -->
					<a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow"> 
						Start Project 
						<i class="fal fa-long-arrow-right font-size-xl"></i>
					</a> 
					<a class="btn btn-black" href="tel:3234759216">
			...
			<div class="col-md-4" data-aos="fade-right" data-aos-duration="1200">
				<!-- <div class="get-started-form">
					<form action="" method="post" class="validate-popupform">
						...
						<input type="text" class="required input-control form-control" name="full_name" required id="name" placeholder="Full Name" />
						<input type="email" class="required input-control form-control email" required name="email" placeholder="Email Address">
						<input type="tel" class="required input-control form-control" required name="telephone" placeholder="Phone Number">
						...
						<div class="py-3">
							<input type="submit" id="register" class="btn btn-yellow" name="send_data" value="Send Message">
							<br /> 
						</div>
					<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI'] ?>">
<input type="hidden" name="brand" value="AMAZONKDPEXPERT">
...
<input type="hidden" name="news" value="1">
	...
	<div class="logos d-flex justify-content-center flex-wrap mt-4">
    <div class="col-3 mx-2 d-flex justify-content-center">
        <a href="https://www.trustpilot.com/review/amazonkdpexpert.com">
            <img src="/assets/images/trust.png" class="img-fluid logos2" alt="Trust Logo">
        </a>
    </div>
    <div class="col-3 mx-2 d-flex justify-content-center">
        <a href="https://www.bark.com/en/us/company/amazon-kdp-expert/oRwJy/">
            <img src="/assets/images/bark.png" class="img-fluid logos2" alt="Logo 1">
        </a>
    </div>
    <div class="col-3 mx-2 d-flex justify-content-center">
        <a href="https://clutch.co/profile/amazon-kdp-expert#highlights">
            <img src="/assets/images/clutch.png" class="img-fluid logos2" alt="Logo 2">
        </a>
    </div>
</div>
	...
	<div class="container" data-aos="fade-down" data-aos-duration="1000">
		<div class="row">
			<div class="col-md-6 m-auto">
				...
				<p class="py-3">Ready to tell the world your story or are you still struggling to <span class="d-block">make it past the plot twist?</span></p> 
				<a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i class="fal fa-long-arrow-right font-size-xl"></i></a> 
				<a class="btn btn-black" href="tel:3234759216"><i class="fas fa-phone-alt"></i> &nbsp; Call Now</a> 
			</div>
			<div class="col-md-6">
				<img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/featured-image-2.jpg">
			</div>
		</div>
		<div class="row align-items-center py-4">
			<div class="col-md-4" data-aos="zoom-in-down" data-aos-duration="1200">
				<div class="pub-img"> <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/pub1.webp" alt="amazon kdp expert">
					<h4 class="pt-3 pb-2">Self-Publishing</h4>
					<p>Our comprehensive self-publishing package means you don’t have to lift a finger at all.</p>
				</div>
			</div>
			<div class="col-md-4" data-aos="zoom-in-down" data-aos-duration="1200">
				<div class="pub-img"> <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/pub2.webp" alt="amazon kdp expert">
					<h4 class="pt-3 pb-2">Proofreading</h4>
					<p>We provide professional proofreading to help you deliver your readers a flawless book.</p>
				</div>
			</div>
			<div class="col-md-4" data-aos="zoom-in-down" data-aos-duration="1200">
				<div class="pub-img"> <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/pub3.webp" alt="amazon kdp expert">
					<h4 class="pt-3 pb-2">Copy Editing</h4>
					<p>Our skilled editors have extensive experience copy-editing books in every genre.</p>
				</div>
			</div>
		...
		<div class="row align-items-center py-4">
			...
			<div class="col-md-4" data-aos="zoom-in-down" data-aos-duration="1200">
				<div class="pub-img"> <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/pub4.webp" alt="amazon kdp expert">
					<h4 class="pt-3 pb-2">Book Cover Design</h4>
					<p>Get a professional book cover design with unlimited revisions so you make a lasting impression.</p>
				</div>
			</div>
			<div class="col-md-4" data-aos="zoom-in-down" data-aos-duration="1200">
				<div class="pub-img"> <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/pub5.webp" alt="amazon kdp expert">
					<h4 class="pt-3 pb-2">Illustrations</h4>
					<p>We create eye-catching illustrations to capture your reader’s imagination and get them excited to read further.</p>
				</div>
			</div>
			<div class="offset-md-2"></div>
		</div>
...
<section class="cta">
   <div class="container" data-aos="zoom-in" data-aos-duration="1000">
      <div class="row align-items-center">
         ...
         <div class="col-md-6">
            <h3 class="py-4">There is no limit to what you can achieve with a book under your Name.</h3> <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-black">Start Project 
               <i class="fal fa-long-arrow-right"></i> 
              </a> 
              <a class="btn btn-white-border btn-black" href="tel:3234759216">
...
<section class="book-stone">
	<div class="container" data-aos="fade-up" data-aos-duration="1000">
		<div class="row align-items-center">
			<div class="col-md-7">
				<h2>The world is waiting for your book. Our publishing service can help you.</h2>
				<p class="py-3"> Having a book written is an incredibly efficient and proven way of changing your lifestyle and your career. At amazon kdp expert, we translate your passions onto paper. We assist clients in writing and publication of their book from conception to completion.</p>
				<ul class="menu menu-dot pb-3">
				...
				</ul> <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
                            class="fal fa-long-arrow-right"></i></a> <a class="btn btn-black" href="tel:3234759216"><i class="fas fa-phone-alt"></i> &nbsp; Call
                        Now</a> </div>
			<div class="col-md-5"> <img class="lazy" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="assets/images/creative-book.png" alt="" style="width:500px;"> </div>
		</div>
	</div>
</section>
  ...
  <div class="container" data-aos="slide-up" data-aos-duration="1000">
    <div class="row align-items-center">
      <div class="col-md-6">
        ...
        <p class="text-white pt-2 pb-3">Challenge us. We want to work with you to create the really cool stuff.</p> <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i class="fal fa-long-arrow-right"></i></a> <a class="btn btn-black" href="tel:3234759216"><i class="fas fa-phone-alt"></i> &nbsp; Call Now</a> </div>
...
<section class="faq-sec">
 ...
 <?php include_once("includes/footerform.php") ?>
