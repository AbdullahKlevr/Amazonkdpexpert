...
<input type="hidden" name="news" value="1">
           <input type="hidden" name="subject" value="Banner Form (amazonkdpexpert.com)"></form>
					...
					<!--</a> -->
					<a href="javascript:;" onclick="setButtonURL();" class="btn btn-yellow"> 
						Start Project 
						<i class="fal fa-long-arrow-right font-size-xl"></i>
					</a> 
					<a class="btn btn-black" href="tel:+17275135653">
	...
	<div class="container" data-aos="fade-down" data-aos-duration="1000">
		<div class="row">
			<div class="col-md-6 m-auto">
				...
				<a href="javascript:;" onclick="setButtonURL();" class="btn btn-yellow">Start Project <i class="fal fa-long-arrow-right font-size-xl"></i></a> 
				<a class="btn btn-black" href="tel:+17275135653"><i class="fas fa-phone-alt"></i> &nbsp; Call Now</a> 
			</div>
			<div class="col-md-6">
      ...
      <div class="row align-items-center">
         ...
         <div class="col-md-6">
            <h3 class="py-4">There is no limit to what you can achieve with a book under your Name.</h3> <a href="javascript:;" onclick="setButtonURL();" class="btn btn-black">Start Project 
              ...
              <a class="btn btn-white-border btn-black" href="tel:+17275135653">
	...
	<div class="container" data-aos="fade-up" data-aos-duration="1000">
		<div class="row align-items-center">
			<div class="col-md-7">
				...
				</ul> <a href="javascript:;" onclick="setButtonURL();" class="btn btn-yellow">Start Project <i
                            class="fal fa-long-arrow-right"></i></a> <a class="btn btn-black" href="tel:+17275135653"><i class="fas fa-phone-alt"></i> &nbsp; Call
                        Now</a> </div>
  ...
  <div class="container" data-aos="slide-up" data-aos-duration="1000">
    <div class="row align-items-center">
      <div class="col-md-6">
        ...
        <p class="text-white pt-2 pb-3">Challenge us. We want to work with you to create the really cool stuff.</p> <a href="javascript:;" onclick="setButtonURL();" class="btn btn-yellow">Start Project <i class="fal fa-long-arrow-right"></i></a> <a class="btn btn-black" href="tel:+17275135653"><i class="fas fa-phone-alt"></i> &nbsp; Call Now</a> </div>
