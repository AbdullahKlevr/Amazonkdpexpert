...
<section class="banner inner-banner inner-banner9">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-8" data-aos="fade-left" data-aos-duration="1200">
            <h5 class="text-white pb-3">Ensuring Worldwide Publication of your Stories on Amazon</h5>
            <h1 class="text-white">Publish Your Book on Amazon through our <span
               class="d-content primary-color">Amazon Publishing Services</span></h1>
            <p class="text-white py-3">
               There are hundreds of thousands of writers who have poured their heart and soul into writing a
               manuscript, but book publishing companies reject them for some odd reasons. We provide solutions
               for all those aspiring authors at Amazon Publishing to address the multi-faceted 'strange
               reasons' that are blocking them from actualizing their dreams. Our company of professional book
               publishers helps aspiring writers make their mark and earn the reputation they deserve through
               Amazon.
            </p>
            <div class="trust">
               <div class="new_frm">
...
<input type="hidden" name="news" value="1">
           <input type="hidden" name="subject" value="Banner Form (amazonkdpexpert.com)"></form>
               ...
               <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
                  class="fal fa-long-arrow-right font-size-xl"></i></a>
               <a class="btn btn-black" href="tel:3234759216"><i class="fas fa-phone-alt"></i> &nbsp; Call
               Now</a>
            </div>
         </div>
...
<input type="hidden" name="news" value="1">
           <input type="hidden" name="subject" value="Banner Form (amazonkdpexpert.com)"></form>
         	...
         	<div class="logos d-flex justify-content-start flex-wrap mt-4">
...
<section class="book-stone">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-6">
            <h2>Providing the most Ideal and Robust Publishing Process on Amazon.</h2>
            <p class="py-3"> Amazon Publishing is one of the best publishing agencies, specializing in all
               genres, formats and publishing platforms, particularly Amazon. By assisting thousands of fiction
               writers to become documented authors, our book publishing agents have a reputation for
               delivering quality services. Amazon Publishing is home to the most experience writing executives
               who take control in almost every niche. We guarantee you the most rapid and uncomplicated
               process for self-publishing a book. Our top-notch Amazon Publishing Services has helped aspiring
               writers to become award-winning authors on Amazon.
            </p>
            <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
         ...
         <div class="col-md-6">
            <img src="assets/images/b-trans.png" alt="" style="width:600px;">
         </div>
      </div>
   </div>
</section>
