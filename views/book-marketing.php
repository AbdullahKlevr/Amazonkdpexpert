...
<section class="banner inner-banner inner-banner7">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-7" data-aos="fade-left" data-aos-duration="1200">
            <h5 class="text-white pb-3">We enable you to reach your audience anywhere in the world.</h5>
            <h1 class="text-white">Affordable <span class="d-content primary-color"> Book Marketing Services
               </span> for Self-published Authors. 
            </h1>
            <p class="text-white py-3">
               Are you looking for affordable marketing to reach your target audience? We’ve got you covered.
               We provide efficient marketing to reach, inspire and grow the audience for your book. Amazon
               Publishing Pros’ exceptional marketing team will ensure that your piece of art gets the
...
<section class="book-stone">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-6">
            <h2>Effective Sales-Centric Digital Marketing for Self-published Authors</h2>
            <p class="py-3"> From Search Engine Optimization (SEO) to Social Media Marketing, we’ve got you
               covered. At amazon kdp expert, our marketing team makes sure your published book gains
               maximum interest from its target audience. Our expert digital marketers use their expertise to
               promote your book and reach potential customers. amazon kdp expert are your one-stop source
               for all your book marketing solutions.
            </p>
            <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
         ...
         <div class="col-md-6">
            <img src="assets/images/book-marketing.png" alt="" style="width:650px;">
         </div>
      </div>
   </div>
</section>
