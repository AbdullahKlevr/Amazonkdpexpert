      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <p class="para2">A refund request can be submitted if you are not satisfied with any product or
               service
               provided by amazon kdp expert within 5 days of your order completion. Certain
               percentage
               based
            ...
            <ul style="menu">
               <li>The information provided on www.amazonkdpexpert.com includes, but is not limited to,
                  the
      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <p class="para2">This policy outlines the terms and conditions regarding the use of email and
               mobile
               phone contact information provided to amazon kdp expert.
            </p>
            ...
            <p class="para2">By providing your email address and/or mobile phone number, you consent to
               receive
               communication from amazon kdp expert. This includes, transitional messages, periodic
               updates
            ...
            <p class="para2">amazon kdp expert reserves the right to modify this policy at any time.
               Any
