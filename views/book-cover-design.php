...
<section class="banner inner-banner inner-banner3">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-7" data-aos="fade-left" data-aos-duration="1200">
            <h5 class="text-white pb-3">Design that makes a statement.</h5>
            <h1 class="text-white">Crafting Eye-catching <span class="d-content primary-color"> Book Cover
               Designs </span> to Inspire You and Your Readers
            </h1>
            <p class="text-white py-3">
               It's not just about judging a book by its cover. Attractive book covers can persuade the readers
               to buy a book; that’s why it’s essential to a book’s success. Our expert designers at Amazon
               Publishing Pros know precisely how to design a book cover that sells!
            </p>
            <div class="trust">
               <div class="new_frm">
...
<section class="book-stone">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-6">
            <h2>Stunning Book Covers that Will Stand Out!</h2>
            <p class="py-3"> Our skilled designers use their expertise to design the perfect cover to make your
               title stand out, which tells more about the story and attracts readers at first sight. With
               amazon kdp expert, you’ll have a book cover that is always on the front shelves.
            </p>
            <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
         ...
         <div class="col-md-6">
            <img src="assets/images/book-cover.png" alt="" style="width:650px;">
         </div>
      </div>
   </div>
</section>
