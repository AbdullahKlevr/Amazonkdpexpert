   ...
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-7" data-aos="fade-left" data-aos-duration="1200">
            <h5 class="text-white pb-3">Step Into The Digital World</h5>
            <h1 class="text-white">Get Your <span class="d-content primary-color">Customized E-Book</span>
               Through Our Expert E-Book Writers
            </h1>
            <p class="text-white py-3">
               At amazon kdp expert, our team of executive e-book writers take your ideas and transform
               them into top-quality e-books at affordable prices.
            </p>
            <div class="trust">
               <div class="new_frm">
...
<section class="book-stone">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-6">
            <h2>Take Your E-Books To The Next Level With amazon kdp expert</h2>
            <p class="py-3"> With the world going digital, rank your e-books amongst the best e-books worldwide.
               Our team of storytellers maintain the quality and standards required for you to become a
               top-seller throughout the e-book writing process. Our main goal is to provide authentic leads
               for our highly valued customers.
               in writing and publication of their book from conception to completion.
            </p>
            <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
         ...
         <div class="col-md-6">
            <img src="assets/images/e-book.png" alt="" style="width:650px;">
         </div>
      </div>
   </div>
</section>
