   ...
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-8" data-aos="fade-left" data-aos-duration="1200">
            ...
            <h1 class="text-white">Engage Your <span
               class="d-content primary-color">Readers Online</span>For a More Personalized Experience</h1>
            <p class="text-white py-3">
              Looking to build your author’s website that showcases your books, grows your reader’s list, and attracts publishers and promoters? Let Amazon kdp expert take care of it.
            </p>
            <div class="trust">
               <div class="new_frm">
...
<section class="book-stone">
   <div class="container" data-aos="fade-up" data-aos-duration="1000">
      <div class="row align-items-center">
         <div class="col-md-6">
            <h2>Our Story: A Partnership Built on Love, Coffee, and Business.</h2>
            <p class="py-3"> Amazon kdp expert’ directors decided it would be a lot more fun working together and building something exciting than working on our separate career paths. Our Amazon Publishing Pros’ director is a visual art major. He's done everything creative in the field, from giant oils paintings to classical Greek sculptures and architectural enrichments for Russian castles.
            </p>
            <a href="javascript:;" onclick="LiveChatWidget.call('maximize');" class="btn btn-yellow">Start Project <i
