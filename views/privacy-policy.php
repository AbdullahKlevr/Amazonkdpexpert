   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            ...
            <ul style="text-align: left;">
               <li>Information of clients at amazon kdp expert is kept extremely secure during
                  transmission by the
                  use of the Secure Sockets Layer (SSL) Software which encrypts information that client puts
                  in.
               </li>
               <li>amazon kdp expert follows generally accepted industry standards to protect the personal
            ...
            <ul style="text-align: left;">
               ...
               <li>amazon kdp expert utilizes services of credit card processing companies to bill you for
            ...
            <ul style="text-align: left; margin-bottom: 50px;">
               ...
               <li>amazon kdp expert keeps track of your IP address to help diagnose problems with our
                  server and
            ...
            <p class="para2">This Privacy Policy explains how amazon kdp expert collects, uses, and
               protects the
            ...
            <p class="para2">By providing your mobile number on amazon kdp expert, you consent to the
               collection
            ...
            <p class="para2">• If you have previously agreed to us using your mobile number for direct marketing
               ...
               marketing@amazonkdpexpert.com.or
            ...
            <p class="para2">You have the right to request details of the personal information we hold about
               you. If you
               would like a copy of this information, please contact us at marketing@amazonkdpexpert.com.
            </p>
            <h2 class="heading2">9. Changes to this Policy</h2>
            <p class="para2">amazon kdp expert may change this policy from time to time by updating this
               page. You
...
<section class="signup">
   <div class="container" data-aos="fade-down" data-aos-duration="1200">
      ...
      <p class="pt-2 pb-4 text-center">Get Your Book Written and Published in Less Than A Month!
         <span class="d-block">
         Call Us at <a href="tel:+17275135653"> +1 (727) 513-5653</a>
         </span>
      </p>
      <div class="col-md-12">
         <form action="" method="post" class="validate-letsget">
            ...
            <a href="https://amazonkdpexpert.com/privacy-policy">PRIVACY POLICY </a>
            & <a href="https://amazonkdpexpert.com/terms-and-conditions">TERM & CONDITIONS</a> )
...
<script>
      ...
      <!-- Start of acebookwriters Zendesk Widget script -->
<script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=4298473a-615d-4e1b-b26f-a4a720af9e5a"> </script>
<!-- End of acebookwriters Zendesk Widget script -->
